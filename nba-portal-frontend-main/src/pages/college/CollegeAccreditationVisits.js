...
import './CollegeAccreditationVisits.css'
            ...
            <tr>
              <th colspan="3">
                <div className="w-100 d-flex justify-content-around">
                  ...
                  <button style={{whiteSpace: "nowrap", marginLeft: "10px", backgroundColor: "#6AC6FF"}}>Apply For Accreditation</button>
                </div>
              </th>
            </tr>
        </tfoot>
...
const CollegeAccreditationVisits = () => {
...
export default CollegeAccreditationVisits;